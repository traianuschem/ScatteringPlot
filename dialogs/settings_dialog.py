...
class PlotSettingsDialog(QDialog):
    ...
    def __init__(self, parent, axis_limits):
        ...
        # Achsenlimits
        limits_group = QGroupBox(tr("settings.axis_limits"))
        limits_layout = QGridLayout()

        limits_layout.addWidget(QLabel(tr("settings.x_min")), 0, 0)
        ...
        limits_layout.addWidget(QLabel(tr("settings.x_max")), 0, 2)
