...
class ReferenceLinesDialog(QDialog):
    ...
    def __init__(self, parent):
        ...
        self.setWindowTitle("Referenzlinie hinzufügen")

        layout = QVBoxLayout(self)

        # Typ-Gruppe
        type_group = QGroupBox("Typ")
        type_layout = QGridLayout()

        type_layout.addWidget(QLabel("Orientierung:"), 0, 0)
        self.type_combo = QComboBox()
        self.type_combo.addItems(['Vertikal', 'Horizontal'])
        ...
        pos_layout.addWidget(QLabel("Wert:"), 0, 0)
        ...
        pos_layout.addWidget(QLabel("Label:"), 1, 0)
        self.label_edit = QLineEdit()
        self.label_edit.setPlaceholderText("Optional (z.B.: q = 0.5)")
        ...
        style_layout.addWidget(QLabel("Linientyp:"), 0, 0)
        ...
        style_layout.addWidget(QLabel("Liniendicke:"), 1, 0)
        ...
        style_layout.addWidget(QLabel("Farbe:"), 2, 0)
        ...
        style_layout.addWidget(QLabel("Alpha:"), 3, 0)
    ...
    def choose_color(self):
        ...
        color = QColorDialog.getColor(QColor(self.color), self, "Linienfarbe")
        if color.isValid():
